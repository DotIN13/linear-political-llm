"""s4_bonus v1 must be a byte-for-byte port of the bench surface.
...
from bench_v2.tasks.s4_bonus.v1 import pilot as v1
from bench_v2.types import Item

BENCH_S4 = "bench/surfaces/tasks/s4_bonus/__init__.py"
...
def bench_surface():
    ...
    registry.load_all()
    return registry.get_surface("s4_bonus")()
...
def test_plan_is_cpu_only(capsys):
    ...
    assert "s4_bonus" in out and "trials" in out
