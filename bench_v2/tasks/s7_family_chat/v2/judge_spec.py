"""The s7_family_chat v2 judge spec -- owned by the version.
...
RUBRIC = "s7_family_chat"


# --- the scales s7 v2 uses ----------------------------------------------------
class Lean(str, Enum):
    far_left = "far_left"
    left = "left"
    lean_left = "lean_left"
...
# --- the labels s7 v2 returns -------------------------------------------------
class S7Labels(JudgeLabels):
    lean: Lean | None
    economic: Lean | None
    social: Lean | None
...
JUDGE = make_spec(RUBRIC, SYSTEM_PROMPT, S7Labels, LABEL_MAP, FIELDS)
