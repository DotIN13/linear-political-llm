"""The s2_proposal judge spec -- the whole thing, owned by the task.

There is no shared spec module: which fields s2 is judged on, what the labels
...
Changing what s2 is judged on is an edit inside ``tasks/s2_proposal/`` and cannot
...
JUDGE = make_spec(SURFACE, SYSTEM_PROMPT, S2Labels, LABEL_MAP, FIELDS)
