#!/usr/bin/env python3
"""
Generate score-data JSONL for EasyPortrait images.
"""
...
DEFAULT_IMAGE_DIR = "datasets/EasyPortrait/data/images"
...
DEFAULT_OUTPUT_PATH = "data/probes/easyportrait_score_data.jsonl"
IMAGE_EXTENSIONS = ("*.jpg", "*.jpeg", "*.png", "*.webp")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build EasyPortrait score-data JSONL.",
